...
$fnl= $letter.$month.$key.$ticket;
        ...
        // $sql ="INSERT INTO `refundTable`(`refundId`, `passengerId`, `cancellationFees`, `causes`, `comment`, `refundStatus`) VALUES ('$refundId','$passengerId','$cancellationFees','$causes','$comment','$refundStatus')";
        $sql ="INSERT INTO `refundTable`(`refundId`, `passengerId`, `cancellationFees`, `causes`, `comment`, `refundStatus`) VALUES ('$refundId','$passengerId','$cancellationFees','$causes','$comment','$refundStatus')";
...
<body style="background-color:#E0FFFF">
    ...
    <div class="container mt-5 pt-2">
        <div class="text-center m-5">
            <h3>Refund Form</h3>
            <p class="text-muted">Create Refund</p>
        </div>
            ...
            <form action="" method="post" style="width: 30vh; min-width: 800px;">
                <div class="row">
                    ...
                    <div  class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="passengerId" id="passengerId" placeholder="Passenger Id">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="cancellationFees" placeholder="Cancellation Fees">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="causes"  placeholder="Causes">
                    </div>
                    <div  class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="comment" placeholder="Comment">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="refundStatus" placeholder="Refund Status">
                    </div>
...
$(document).ready(function(){
   $("#passengerId").autocomplete({
       source: 'auto/autoSuggestPassenger.php',
     }); 
})
