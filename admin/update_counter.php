                ...
                <div class="row">
                    <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $sql="UPDATE `counter` SET `agentName`='$agentName',`location`='$location',`counterName`='$counterName',`number`='$number',`counterStatus`='$counterStatus' WHERE `agentId`='$Id';";
                        ...
                        $id=$_GET['AID'];
                        $sql="SELECT * FROM `counter` WHERE agentId='$id';";
                        $query= mysqli_query($conn, $sql);
                    ...
                    <!--</div>-->
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" autocomplete="off" name="agentName" id="agentName" value="<?php echo $row[1]?> ">
                        
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="location"  value="<?php echo $row[2]?>">
                    </div>
                    <div class="mb-2 col-md-6" >
                        <input type="text" class="form-control" name="counterName" value="<?php echo $row[3]?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="number" value="<?php echo $row[4]?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="counterStatus"  value="<?php echo $row[5]?>">
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="counter_list.php" class="btn btn-danger">Cancel</a>
                        <br><br>
