...
$fnl=$key.$year.$letter.$ticket;
        ...
        $sql ="INSERT INTO `counter`(`agentId`, `agentName`, `location`, `counterName`, `number`, `counterStatus`) VALUES ('$agentId','$agentName','$location','$counterName','$number','$counterStatus');";
...
<body style="background-color:#E0FFFF">
    ...
    <div class="container mt-5 pt-3">
        <div class="text-center spacer-t m-5">
            <h3>Add New Counter For Passenger Help</h3>
        </div>
        <div class="container d-flex justify-content-center">
            ...
            <form action="" method="post" style="width: 30vh; min-width: 800px;">
                <div class="row">
                    ...
                    <div class="mb-2 col-sm-6" >
                        <input type="text" class="form-control" name="counterName" placeholder="counterName">
                    </div>
                    <div class="mb-2 col-sm-6">
                        <input type="text" class="form-control" name="number" placeholder="Your Number">
                    </div>
                    <div class="mb-2 col-sm-6">
                        <input type="text" class="form-control" name="counterStatus"  placeholder="Counter Status">
                    </div>
