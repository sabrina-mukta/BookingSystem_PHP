...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container">Passenger List</h2>
        <div style="overflow-x:scroll" class="container-fluid tab">
        <a href="add_passenger.php" class="btn btn-dark mb-2">ADD NEW</a>
  <table class="tb table table-striped table-bordered table-hover mt-1 " id="pId" >
    ...
    <tr>
        ...
        <td class="form-control text-center bg-light">
            <a href="delete_passenger.php?passengerId=<?php echo $row[0];?>"><i class="bi bi-trash text-danger"></i></a>
