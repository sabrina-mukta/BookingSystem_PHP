<?php
    ...
    $ticket=rand(10000,99999);
        ...
        $sql ="INSERT INTO `busSchedule`(`scheduleId`, `busId`, `busName`, `routeId`, `busStartTime`, `busStartDate`, `startPoint`, `endPoint`, `price`, `distance`, `status1`,`routeName`) VALUES ('$scheduleId','$busId','$busName','$routeId','$busStartTime','$busStartDate','$startPoint','$endPoint','$price','$distance','$status','$routeName');";
        ...
        <div class="container d-flex justify-content-center">
            ...
            <form action="" method="post" style="width: 30vh; min-width: 800px;">
                <div class="row">
                    ...
                    <div class="mb-2 col-md-6">
                        <input type="date" class="form-control" name="busStartDate" id="busStartDate" placeholder="Bus Start Date">
                    </div>
                    <div class="mb-2 col-md-6">
