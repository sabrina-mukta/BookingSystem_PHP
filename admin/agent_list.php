...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container ">Agent List</h2>
        <div class="container-fluid tab" style="overflow-x:scroll;">
            <a href="add_agent.php" class="btn btn-dark mb-2">ADD NEW </a>
  <table class="tb table table-striped table-bordered table-hover mt-3 " id="agentTable">
   ...
   <?php 
    ...
    <tr>
        ...
        <td><embed src="<?php echo $row[5]?>" width="100px" height="100px" /></td>
        <td><img src="<?php echo $row[6]?>"  width="100" height="100"></td>
        ...
        <td class="form-control text-center bg-light">
            <a href="delete_agent.php?agentId=<?php echo $row[0];?>"><i class="bi bi-trash text-danger"></i></a>
            <a href="update_agent.php?agentId=<?php echo $row[0];?>"><i class="bi bi-pen text-info"></i></a>
        </td>
    </tr>
    <?php } ?>
    </tbody>
