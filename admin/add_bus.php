...
$fnl=$key.$year.$letter.$ticket;
        ...
        $sql ="INSERT INTO `busTable`(`busId`, `routeId`, `routeName`, `busNo`, `busName`,`price`, `seatNo`, `seatStatus`) VALUES ('$busId','$routeId','$routeName','$busNo','$busName','$price','$seatNo','$seatStatus');";
...
.btn1:hover {
  background: #e08ddf;
  background-image: -webkit-linear-gradient(top, #e01631, #e01631);
  background-image: -moz-linear-gradient(top, #e01631, #e01631);
  background-image: -ms-linear-gradient(top, #e01631, #e01631);
  background-image: -o-linear-gradient(top,#e01631, #e08ddf);
  background-image: linear-gradient(to bottom,#e08ddf, #3498db);
  text-decoration: none;
  transform: rotateX(5deg);
  box-shadow: 0 15px 15px #f05db3;
...
a.container{
    ...
    <title> Booking System || Add Bus</title>
...
<body style="background-color:#E0FFFF">
   ...
   <main class="mt-5 pt-3 ">
        <div class="container">
            <h3 class=" text-center" style="margin-top:150px">Add New Bus to your Company</h3>
        ...
        <div class="container d-flex justify-content-center">
            <div class="row">
                ...
                <div class=col col-md-8>
                 <form action="" method="post" id="basic-form"   style="width: 30vh; min-width: 800px;margin-top:26px ">
                <div class="row align-items-center">
                    ...
                    <div class="mb-2 col-sm-6 ">
                        <input type="text" class="form-control" name="routeName" id="routeName" placeholder="Route Name" onchange='selectRouteId()'  required>
                    </div>
                    <div class="mb-2 col-sm-6">
                    ...
                    <div class="mb-2 col-md-6">
                        <select class="form-select" aria-label="Default select example" name="busName">
                              <option selected value="0">Select Bus</option>
                    ...
                    <div class="mb-2 col-md-6">
                        <select class="form-select" aria-label="Default select example" name="seatStatus">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="bus_list.php" class="btn btn1 ">Cancel</a>
                        <br><br>
                    </div>
                </div>
            </form> 
