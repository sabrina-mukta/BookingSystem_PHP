<?php
    ...
    $fnl=$key.$year.$month.$day.$letter.$ticket;
        ...
        $offerCreationDate = $_POST['offerCreationDate'];
            ...
            <form action="" method="post" style="width: 30vh; min-width: 800px;">
                <div class="row">
                    ...
                    <div class="mb-2 col-md-6" >
                        ...
                        <input type="datetime-local" class="form-control" name="startDate" placeholder="Start Date">
                    </div>
                    <div class="mb-2 col-md-6">
                    <label for="start-date">End Date:</label>
                        <input type="datetime-local" class="form-control" name="endDate" placeholder="End Date">
                    </div>

                    <div class="mb-2 col-md-6">
                    <label for="">Offer Status:</label>
                        <input type="text" class="form-control" name="offerStatus"  placeholder="Offer Status">
                    </div>
                    <div class="mb-2 col-md-6">
                        <label for="">Offer Creation Date:</label>
                        <input type="datetime-local" class="form-control" name="offerCreationDate"  placeholder="">
                    </div>
