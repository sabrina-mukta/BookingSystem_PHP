...
if(isset($_POST['submit'])){
                            ...
                            $cancellationFees = $_POST['cancellationFees'];
                            $causes = $_POST['causes'];
                            $comment = $_POST['comment'];
                            $refundStatus = $_POST['refundStatus'];
                            $sql="UPDATE `refundTable` SET `passengerId`='$passengerId',`cancellationFees`='$cancellationFees',`causes`='$causes',`comment`='$comment',`refundStatus`='$refundStatus' WHERE `refundId`='$id';";
...
<body style="background-color:#E0FFFF">
    ...
    <div class="container mt-5 pt-2">
        <div class="text-center m-5">
            <h3>Refund Form</h3>
            <p class="text-muted">Complete the form below to Why you refund your money</p>
        </div>
            ...
            <form action="" method="post" style="width: 30vh; min-width: 800px;">
                <div class="row">
                    <?php
                        ...
                        $id=$_GET['refundId'];
                        $sql="select * from refundTable where refundId='$id'";
                        $query= mysqli_query($conn, $sql);
                    ...
                    <div  class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="passengerId" placeholder="Passenger Id" value="<?php echo $row[0];?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="cancellationFees" placeholder="Cancellation Fees" value="<?php echo $row[1];?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="causes"  placeholder="Causes" value="<?php echo $row[2];?>">
                    </div>
                    <div  class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="comment" placeholder="Comment" value="<?php echo $row[3];?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="refundStatus" placeholder="Refund Status" value="<?php echo $row[0];?>">
                    </div>
                    
                    
                    <div class="mt-4">
                        <button type="submit" name="submit" class="btn btn-success">SAVE</button>
                        <a href="refund_list.php" class="btn btn-danger">CANCEL</a>
                        <br><br>
                    </div>
                    <?php }?>
                </div>
