...
a.container{
    ...
    <title> Booking System || Route List</title>
...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container g-0">Rute List</h2>
        <div class="container-fluid tab">
            <a href="add_route.php" class="btn btn-dark ">Add New</a>
            <hr>
  <table class="tb table table-striped table-bordered table-hover mt-3 btable text-center" id="ruteList" >
