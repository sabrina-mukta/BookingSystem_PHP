...
<body style="background-color:#E0FFFF">
  ...
  <table class="tb table table-striped table-bordered table-hover mt-3 "  id="counterList">
    ...
    <tr>
        ...
        <a href="delete_counter.php?agentId=<?php echo $row[0];?>"><i class="bi bi-trash text-danger"></i></a>
        <a href="update_counter.php?agentId=<?php echo $row[0];?>"><i class="bi bi-pen text-infof"></i></a>
        </td>
    </tr>
    <?php } ?>
    </tbody>
