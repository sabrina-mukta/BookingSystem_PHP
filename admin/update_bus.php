                ...
                <div class="row">
                    <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $sql="UPDATE busTable SET routeId='$routeId',routeName='$routeName',busNo='$busNo',busName='$busName',price='$price',seatNo='$seatNo',seatStatus='$seatStatus' WHERE busId='$id';";
                    ...
                    <!--</div>-->
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" id="routeName" name="routeName" onchange='selectRouteId()' value="<?php echo $row[2]?>">
                    </div>
                    
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="busNo"  value="<?php echo $row[3]?>">
                    </div>
                    <!--<div class="mb-2 col-md-6" >-->
                    <!--    <input type="text" class="form-control" name="busName" value="<?php echo $row[4]?>">-->
                    <!--</div>-->
                    <div class="mb-2 col-md-6">
                        <select class="form-select" aria-label="Default select example" name="busName">
                            <?php 
                                if($row[4]=="Hino AK1J, Non-AC"){$busN = "Hino AK1J, Non-AC";}
                                elseif($row[4]=="Hino 1J, Non-AC"){$busN = "Hino 1J, Non-AC";}
                                elseif($row[4]=="Isuzu, Non-AC"){$busN = "Isuzu, Non-AC";}
                                elseif($row[4]=="Scania, AC"){$busN = "Scania, AC";}
                                elseif($row[4]=="Hyundai Universe, AC"){$busN="Hyundai Universe, AC";}
                                elseif($row[4]=="Hino 1J Plus, AC"){$busN = "Hino 1J Plus, AC";}
                            ?>
                              <option selected value="<?php echo $row[4]?>"><?php echo $busN;?></option>
                              <option value="Hino AK1J, Non-AC" name="">Hino AK1J, Non-AC</option>
                              <option value="Hino 1J, Non-AC" name="" >Hino 1J, Non-AC</option>
                              <option value="Isuzu, Non-AC" name="" >Isuzu, Non-AC</option>
                              
                              <option value="Scania, AC" name="" >Scania, AC</option>
                              <option value="Hyundai Universe, AC" name="" >Hyundai Universe, AC</option>
                              <option value="Hino 1J Plus, AC" name="" >Hino 1J Plus, AC</option>
                          </select>
                    </div>
                    <div class="mb-2 col-md-6" >
                        <input type="decimal" class="form-control" name="price" value="<?php echo $row[7]?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="seatNo" value="<?php echo $row[5]?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" name="seatStatus"  value="<?php echo $row[6]?>">
                    </div>
                    <div class="mb-2 col-md-6">
                        <input type="text" class="form-control" autocomplete="off" name="routeId" id="routeId" value="<?php echo $row[1]?> ">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="bus_list.php" class="btn btn-danger">Cancel</a>
                        <br><br>
