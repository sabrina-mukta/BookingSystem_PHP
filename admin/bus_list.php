...
a.container{
    ...
    <title>Booking System || BUs List</title>
...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container">Bus List</h2>
        <div class="container-fluid tab">
            <a href="add_bus.php" class="btn btn-dark">ADD NEW </a>
            <hr>
  <table class="tb table table-striped table-bordered table-hover mt-3 display btable" id="busList" >
    ...
    <?php 
        include '../config.php';
        $sql = "SELECT * FROM `busTable`";      //Show all Table Value CMD....... 
    ...
    <tr>
        ...
        <?php if($row[6]==1){$routeS = "Active";}else{$routeS = "Inactive";}?>
        <td><?php echo $routeS;?></td>
        <td class="form-control text-left">
            <a href="delete_bus.php?busId=<?php echo $row[0];?>"><i class="bi bi-trash text-danger "></i></a>
            <a href="update_bus.php?bId=<?php echo $row[0];?>"><i class="bi bi-pen text-dark "></i></a>
