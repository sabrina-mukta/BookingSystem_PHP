...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container">Refund List</h2>
        <div class="container-fluid tab">
        <a href="add_refund.php" class="btn btn-dark">ADD NEW </a>
  <table class="tb table table-striped table-bordered table-hover mt-3 " >
    ...
    <?php 
        include '../config.php';
        $sql = "SELECT * FROM `refundTable`";      //Show all Table Value CMD....... 
    ...
    <tr>
        ...
        <td class="form-control text-center bg-light">
            <a href="delete_refund.php?refundId=<?php echo $row[0];?>"><i class="bi bi-trash text-danger"></i></a>
            <a href="update_refund.php?refundId=<?php echo $row[0];?>"><i class="bi bi-pen text-infof"></i></a>
        </td>
    </tr>
    <?php }?>
    </tbody>
