...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container g-0">Bus List</h2>
        <div class="container-fluid tab">
            <a href="add_bus1.php" class="btn btn-dark mb-3">ADD NEW </a>
  <table class="tb table table-striped table-bordered table-hover mt-3 display" id="busList" >
    ...
    <tr>
        ...
        <!--    <a href="update_bus.php?bId=<?php //echo $row[0];?>"><i class="bi bi-pen text-infof"></i></a>-->
