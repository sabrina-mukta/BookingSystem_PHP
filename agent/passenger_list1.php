...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container g-0">Passenger List</h2>
        <div style="overflow-x:scroll" class="container-fluid tab">
        <a href="add_passenger1.php" class="btn btn-dark mb-2">ADD NEW</a>
  <table class="table table-striped bg-light table-bordered table-hover mt-1 " id="pId" >
    ...
    <?php 
        include '../config.php';
        $sql = "SELECT * FROM `passengerTable`";      //Show all Table Value CMD....... 
    ...
    <tr>
        ...
        <td class="form-control text-center bg-light">
            <a href="update_passenger.php"><i class="bi bi-pen text-infof"></i></a>
        </td>
    </tr>
    <?php } ?>
    </tbody>
