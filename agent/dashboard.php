...
$totalSell1=0;
$totalTic1=0;
$sellBy1=$_SESSION['userId'] ;
$totalSell = "SELECT * FROM `bookingTable` where sellBy='$sellBy1' ";
$request6 = mysqli_query($conn, $totalSell);
