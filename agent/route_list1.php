...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container g-0">Rute List</h2>
        <div class="container-fluid tab">
            <a href="add_route1.php" class="btn btn-dark mb-3">Add New</a>
  <table class="tb table table-striped table-bordered table-hover mt-3 btable" id="ruteList" >
    ...
    <?php 
        ...
        include '../config.php';
        $sql = "SELECT * FROM `route`";      //Show all Table Value CMD....... 
    ...
    <tr>
        ...
        <!--<td class="form-control text-center bg-light">-->
            <!--<a href="delete_route.php?routeId=<?php //echo $row[0] ?>"><i class="bi bi-trash text-danger"></i></a>-->
            <!--<a href="update_route.php?rId=<?php //echo $row[0];?>"><i class="bi bi-pen text-info"></i></a>-->
        <!--</td>-->
    </tr>
    <?php }?>
    </tbody>
