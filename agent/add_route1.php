...
$fnl=$key.$letter.$letter1.$ticket;
        ...
        if($request){
            header("Location:route_list1.php");
            echo "Success";
        }else{
    ...
    <!-- offcanvas -->
       <div class="container mt-5 pt-1">
        <div class="text-center spacer-t m-5">
            <h3>Add New Rout Details</h3>
            <p class="text-muted">Complete the form below to add a Rout Details</p>
        </div>
            ...
            <form action="" method="post" style="width: 30vh; min-width: 800px;">
                <div class="row">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="route_list1.php" class="btn btn-danger">Cancel</a>
                        <br><br>
                    </div>
                </div>
            </form>
