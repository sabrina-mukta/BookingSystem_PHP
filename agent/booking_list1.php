...
<body style="background-color:#E0FFFF">
    ...
    <div class="offcanvas offcanvas-start sidebar-nav  text-dark " id="sidebar" style="background-color:#fff">
        ...
        <!-----------schedule Start--------------->
         <center>
        <a class="btn bg-primary p-1 m-1 text-white " href="schedule_list1.php" style="width:90%;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'" role="button">Schedule </a>
        </center>
    ...
    <h2 class="container">Booking List</h2>
        <div class="container-fluid tab">
        <div style="overflow-x: auto;">
            <a href="add_booking1.php" class="btn btn-dark mb-2">ADD NEW</a>
    ...
    <tr>
        ...
        <td class="form-control text-center">
            <a href="delete_booking1.php?bookingId=<?php echo $row[0];?>"><i class="bi bi-trash text-danger"></i></a>
            <!--<input type="button" onclick="printDiv('printableArea')" value="" class="bi bi-download"/>-->
            <a href="update_booking1.php?bookId=<?php echo $row[0];?>"><i class="bi bi-pen text-info"></i></a>
...
//     document.getElementById("").src = pdf_uri;

//     var pdf_array = pdf.output("arraybuffer");
//     // var pdf_array = window.print("arraybuffer");
//     // PDF.js here!
//   });
// }
</script>
