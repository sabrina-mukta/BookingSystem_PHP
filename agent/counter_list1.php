...
<body style="background-color:#E0FFFF">
    ...
    <h2 class="container g-0">Counter List</h2>
        <div class="container-fluid tab">
            <!--<a href="add_counter.php" class="btn btn-dark mb-2">ADD NEW </a>-->
  <table class="tb table table-striped table-bordered table-hover mt-3 "  id="counterList">
    ...
    <?php 
        include '../config.php';
        $sql = "SELECT * FROM `counter`";      //Show all Table Value CMD....... 
