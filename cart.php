      ...
      <div class=" rounded  col-8 mt-4"> 
        ...
        <div class="table joy2 " style="margin-left:105px"> 
          <table class="table table-dark table-striped-columns ">
            ...
            <input type="hide" name="bus_id" id="bus_id" hidden value="<?php echo $row[1]?>" />
            ...
            <input type="text" name="shedule_id" id="shedule_id" value="<?php echo $id?>" />
...
//       })
   ...
   function seatBooking(){
       ...
       $.ajax({
           ...
           method:'POST',
           dataType:'html',
           data:{shedule_id:shedule_id,seat_no:seat_no,pay:pay,pay_mobile:pay_mobile,transaction_Number:transaction_Number,totalPrice2:totalPrice2},
           success:function(){
               $('#modalv').modal('hide');
